...
Scnn1a = network.create_nodes(type_name='Scnn1a', N=37)
Rorb = network.create_nodes(type_name='Rorb', N=33)
Nr5a1 = network.create_nodes(type_name='Nr5a1', N=15)
PV1 = network.create_nodes(type_name='PV1', N=8)
PV2 = network.create_nodes(type_name='PV2', N=7)
LIF_exc = network.create_nodes(type_name='LIF_exc', N=297)
LIF_inh = network.create_nodes(type_name='LIF_inh', N=53)

# Compute geometry parameters.
num_nodes = network.node_count()
cyl_center, cyl_height, cyl_radius = cylinder.cylinder_from_density(num_nodes, density = 0.000002, height = 100.0, center=np.array([0,0,0]))
